  ...
  return (
    <aside className="w-64 h-screen bg-white text-white p-4 ">
      ...
      <nav className="flex flex-col gap-2 mt-10">
        ...
        <Link to="/dashboard/profile" className="hover:bg-purple-600 hover:text-white p-4 rounded mt-2 text-black ">Profile</Link>
        <Link to="/dashboard/settings" className="hover:bg-purple-600 hover:text-white  p-4 rounded mt-2 text-black  ">Settings</Link>
      </nav>
    </aside>
  );
}
